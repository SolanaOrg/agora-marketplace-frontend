...
const EtherTopCollectionHolder = (props: any) => {
  const { symbol } = props;
      ...
      async () => {
        try {
          ...
          const get_top_holder: any = await commonService({
            method: `GET`,
            route: `${MARKETPLACES_ETH_API.GET_COLLECTION}/${symbol}/topholders`
          })
                    ...
                    return (
                      <tr key={idx} >
                        ...
                        <td>
                          <div className="d-flex align-items-center">
                            <Icons name={97} />
                            <p className="mx-2 sand-a2kewade">{(item.totalValue).toFixed(2)} ETH</p>
                          </div>
                          <div>
                            <h5 className='anbsdksa-oakew'>(${(item.totalValue * ethToUsd).toFixed(2)})</h5>
                          </div>
                        </td>
                        <td>
                          <div className="d-flex align-items-center">
...
export default EtherTopCollectionHolder