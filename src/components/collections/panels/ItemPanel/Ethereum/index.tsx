				...
				<div className='balance-group' >
					<div className='balance-lists' >
						<div className='balance-item average-balance-item ' >
							...
							<div className='price' >  <Icons name={97} /> <p>{balanceByNfts.avg}</p>  </div>
						</div>
						<div className='balance-item lowest-balance-item ' >
							<p className='title' >Lowest NFT</p>
							<div className='price' >  <Icons name={97} /> <p>{balanceByNfts.lowest}</p>  </div>
						</div>
						<div className='balance-item range-balance-item ' >
							<p className='title' >Range</p>
							<div className='price' >  <Icons name={97} /> <p>{balanceByNfts.lowest}</p> - <Icons name={97} /> <p>{balanceByNfts.highest}</p>  </div>
						</div>
