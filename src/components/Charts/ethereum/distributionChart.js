...
const EtherDistributeChart = ({ contractAddress }) => {
      ...
      async () => {
        try {
          const get_distribute = await commonService({
            method: `get`,
            route: `${MARKETPLACES_ETH_API.GET_COLLECTION}/${contractAddress}/list_distribution`
          })
...
export default EtherDistributeChart;